...
contract HongKongPunks is ERC721A, Ownable, ReentrancyGuard {
 using Address for address;
 using Strings for uint;
 
 string  public  baseTokenURI = "ipfs://QmZE5MAvmyC4joiZj36tb6o9KVRo2SZeNtGKcvDRaJWcsD/";
 
 uint256 public  maxSupply = 7777;
 uint256 public  MAX_MINTS_PER_TX = 25;
 uint256 public  FREE_MINTS_PER_TX = 25;
 uint256 public  PUBLIC_SALE_PRICE = 0.003 ether;
 uint256 public  TOTAL_FREE_MINTS = 0;
 bool public isPublicSaleActive = true;
 
 constructor() ERC721A("HongKongPunks", "HONGKONG") {
